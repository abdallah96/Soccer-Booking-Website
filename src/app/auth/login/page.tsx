  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center px-6 sm:px-8 lg:px-12 py-12 relative overflow-hidden">
      <div className="absolute inset-0">
        <div className="absolute top-0 left-0 w-96 h-96 border-2 border-emerald-500/20 rotate-45"></div>
        <div className="absolute bottom-0 right-0 w-64 h-64 border-2 border-blue-500/20 -rotate-12"></div>
      ...
      <div className="relative z-10 max-w-md w-full">
        <div className="relative">
          <div className="absolute -top-4 -right-4 w-full h-full border-2 border-emerald-500/30"></div>
          <div className="relative bg-white/5 backdrop-blur-md border border-white/10 p-8 md:p-10">
            ...
            >
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center">
                  <input type="checkbox" className="w-4 h-4 bg-black border-2 border-white/20 text-emerald-500 focus:ring-emerald-500" />
                  <span className="ml-2 text-sm text-white/60 font-light">Se souvenir de moi</span>
                </label>
                <Link href="/auth/forgot-password" className="text-sm font-light text-emerald-400 hover:text-emerald-300 transition-colors">
                  Mot de passe oublié ?
                </Link>
              </div>
              ...
              <Button
                type="submit"
                isLoading={isLoading}
                className="w-full py-4 bg-emerald-500 text-black font-black text-lg tracking-tight hover:bg-emerald-400 transition-colors"
              >
                SE CONNECTER
              </Button>
            </form>
            ...
            <div className="mt-8 pt-6 border-t border-white/10">
              <p className="text-center text-white/60 font-light">
                ...
                <Link href="/auth/register" className="font-black text-emerald-400 hover:text-emerald-300 transition-colors">
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-white/40 font-light font-mono">
            ...
            <Link href="#" className="text-emerald-400 hover:text-emerald-300">Conditions d'utilisation</Link>
            {' '}et notre{' '}
            <Link href="#" className="text-emerald-400 hover:text-emerald-300">Politique de confidentialité</Link>
          </p>
        </div>
      </div>
    </div>
